...
#      bash hpc_train_and_run.sh --train-only
#      bash hpc_train_and_run.sh --run-only
#
#
####################
# Training options #
...
sbatch --account=gset-2024-hpc --array=1-${n} train_and_run.sh ${output_dir} ${filename} ${train} ${run}
